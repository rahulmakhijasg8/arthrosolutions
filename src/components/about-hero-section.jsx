...
const AboutHeroSection = () => {
  return (
    <section className="w-full bg-[#F4F8FF] py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block md:hidden">
          ...
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-[#2D2D2D] mb-2 font-['Inter'] leading-tight">
              Meet <span className="font-bold text-[#0D4F7A]"> Dr. Mohit </span>
               Upadhyaya
            </h1>
          ...
          <div className="flex flex-col gap-3 mb-8">
            <Link
              href="/schedule"
              className="w-full bg-[#0D4F7A] text-white py-3.5 px-6 rounded-lg font-medium text-center flex items-center justify-between hover:bg-[#1D4ED8] transition-colors"
            >
            ...
            <Link
              href="/consultation"
              className="w-full border border-[#0D4F7A] text-[#0D4F7A] py-3.5 px-6 rounded-lg font-medium text-center flex items-center justify-between hover:bg-[#0D4F7A] hover:text-white transition-colors"
            >
              <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <div className="text-[#64648A] text-xs whitespace-nowrap">Successful Surgeries</div>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-[#4CAF50] mb-1">97%</div>
              <div className="text-[#64648A] text-xs whitespace-nowrap">Patient Satisfaction</div>
            </div>
            <div className="bg-white rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-[#FE7C49] mb-1">7+</div>
              <div className="text-[#64648A] text-xs whitespace-nowrap">Years Experience</div>
            </div>
          </div>
            ...
            <div className="w-full h-[400px] relative rounded-xl overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 bg-white px-3 py-2 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="font-medium text-[#1F2937] text-xs">FRCS Ed Certified</div>
        ...
        <div className="hidden lg:grid lg:grid-cols-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            {/* Action Buttons */}
            <div className="flex flex-col xl:flex-row gap-4 mb-12 max-w-max">
              <Link
                href="/schedule"
                className="bg-[#0D4F7A] w-fit text-white py-4 px-4 rounded-lg font-medium flex items-center justify-between hover:bg-[#1D4ED8] transition-colors"
              >
                <div className="flex items-center gap-3">
                  <Calendar className="w-5 h-5 flex-shrink-0" />
                  <span className="whitespace-nowrap text-[14px]">Schedule Your Joint Assessment</span>
              ...
              <Link
                href="/consultation"
                className="border border-[#0D4F7A] w-fit text-[#0D4F7A] py-4 px-4 rounded-lg font-medium flex items-center justify-between hover:bg-[#0D4F7A] hover:text-white transition-colors"
              >
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 flex-shrink-0" />
                  <span className="whitespace-nowrap text-[14px]">Free 15-Min Tele-Consultation</span>
            ...
            {/* Statistics */}
            <div className="stats-container grid grid-cols-3 gap-2 lg:gap-4 w-150">
              <div className="bg-white rounded-lg p-3 lg:p-4 flex flex-col items-center">
                <div className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#0D4F7A] mb-1">3000+</div>
                <div className="text-[#64648A] font-medium text-xs lg:text-sm whitespace-nowrap">Successful Surgeries</div>
              </div>
              <div className="bg-white rounded-lg p-3 lg:p-4 flex flex-col items-center">
                <div className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#4CAF50] mb-1">97%</div>
                <div className="text-[#64648A] font-medium text-xs lg:text-sm whitespace-nowrap">Patient Satisfaction</div>
              </div>
              <div className="bg-white rounded-lg p-3 lg:p-4 flex flex-col items-center">
                <div className="text-xl lg:text-2xl xl:text-3xl font-bold text-[#FE7C49] mb-1">7+</div>
                <div className="text-[#64648A] font-medium text-xs lg:text-sm whitespace-nowrap">Years Experience</div>
              </div>
            </div>
