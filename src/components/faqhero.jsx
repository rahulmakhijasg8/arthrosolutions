...
export default function Hero({ 
  ...
  return (
    <div className="w-full relative pb-[60px] md:pb-[87px] text-white pt-[41px] md:pt-[52px]">
  ...
  <path d="M148.79 -47.298V24.5309V31.2329H155.492H227.317V93.8229H155.495H148.793V100.525V172.351H86.2026V100.525V93.8229H79.5007H7.67168V31.2329H79.4976H86.1996V24.5309V-47.295L148.79 -47.298ZM155.495 -54H79.4976V24.5309H0.969727V100.528H79.4976V179.056H155.495V100.525H234.022V24.5309H155.495V-54Z" fill="white"/>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mt-[24px] md:mt-[60px] gap-[10px] md:gap-[24px]">
          {isFAQ ? (
            ...
            // Contact Buttons - Fixed for mobile
            <div className="col-span-2 md:col-span-2 lg:col-span-4 mt-[26px] md:mt-0 flex flex-col md:flex-row justify-center items-center gap-[12px] md:gap-[56px] w-full">
              {contactButtons.length > 0 ? contactButtons.map((button, index) => (
                ...
                <>
                  <button className="group bg-white/24 hover:bg-white text-white hover:text-[#0D4F7A] px-[10px] md:px-[14px] py-[10px] md:py-[12px] rounded-lg font-['Inter'] font-[600] text-[12px] md:text-[14px] transition-all duration-300 flex items-center gap-[8px] w-full max-w-[200px] md:min-w-[200px] justify-center">
                    <svg className="w-[14px] stroke-white group-hover:stroke-[#0D4F7A] h-[14px]" fill="none" viewBox="0 0 24 24">
                  ...
                  <button className="group bg-white/24 hover:bg-white text-white hover:text-[#0D4F7A] px-[10px] md:px-[14px] py-[10px] md:py-[12px] rounded-lg font-['Inter'] font-[600] text-[12px] md:text-[14px] transition-all duration-300 flex items-center gap-[8px] w-full max-w-[200px] md:min-w-[200px] justify-center">
                    <svg className="w-[14px] stroke-white group-hover:stroke-[#0D4F7A] h-[14px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button className="group bg-white/24 hover:bg-white text-white hover:text-[#0D4F7A] px-[10px] md:px-[14px] py-[10px] md:py-[12px] rounded-lg font-['Inter'] font-[600] text-[12px] md:text-[14px] transition-all duration-300 flex items-center gap-[8px] w-full max-w-[200px] md:min-w-[200px] justify-center">
                    <svg className="w-[14px] stroke-white group-hover:stroke-[#0D4F7A] h-[14px]" viewBox="0 0 25 24" fill="currentColor">
