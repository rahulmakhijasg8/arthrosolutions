...
const NewCard = ({
  ...
  return (
    <div className="w-full flex flex-col p-[14px] md:p-[24px] justify-center items-center rounded-[8px] bg-white shadow-[0_10px_18px_2px_rgba(0,0,0,0.04)] h-full min-h-fit">
      {/* Icon */}
      {icon && (
      ...
      {/* Title */}
      <h3 className="text-[18px] md:text-[24px] font-[500] text-[#2D2D2D] mt-[24px] leading-[28px] md:leading-[34px] text-center px-6 md:px-5">
        {title}
      </h3>
      ...
      {buttonText && buttonLink && (
        <a
          ...
          className={`
            mt-[18px] md:mt-[24px] px-[10px] md:px-[14px] py-[4px] md:py-[6px] rounded-[6px] flex items-center justify-center gap-[8px] transition-all duration-200 no-underline
