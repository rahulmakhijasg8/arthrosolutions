...
export default function MedicalQuestionForm() {
  ...
  const { 
    ...
    formType: 'Medical Question',
    emailSubject: 'New Medical Question Submission',
    emailRecipient: process.env.NEXT_PUBLIC_DEFAULT_EMAIL || 'medical@yourcompany.com', // Replace with your medical team email
    
    submittingMessage: 'Submitting your medical question...',
    emailSendingMessage: 'Sending your question to our medical team...',
    successMessage: 'Your medical question has been submitted successfully! Our medical team will respond within 24 hours.',
    errorMessage: 'There was an error submitting your question. Please try again.'
  })
  ...
  const validateForm = () => {
    ...
    if (!formData.medicalQuestion || formData.medicalQuestion.trim() === '') {
      newErrors.medicalQuestion = 'Medical question is required'
    } else if (formData.medicalQuestion.trim().length < 10) {
      newErrors.medicalQuestion = 'Please provide more details about your medical question (minimum 10 characters)'
    }
              ...
              <form onSubmit={handleSubmit} className="space-y-[14px] md:space-y-[28px]">
                ...
                <div className="grid md:grid-cols-2 gap-[14px] md:gap-[32px]">
                  <div className="space-y-2">
                    <label className="text-[16px] font-['Inter'] font-[400] text-[#2D2D2D] block">
                ...
                <div className="space-y-2">
                  <label className="text-[16px] font-['Inter'] font-[400] text-[#2D2D2D] block">
                    Your Medical Question <span className="text-red-500">*</span>
                  </label>
                  <textarea
                    placeholder="Please describe your medical question or concern in detail"
                    ...
                    style={{ caretColor: '#374151' }}
                  />
                  {errors.medicalQuestion && <p className="text-red-500 text-sm mt-1">{errors.medicalQuestion}</p>}
                  <p className="text-[#666666] text-sm">
                    Please provide as much detail as possible to help our medical team give you the best guidance.
                  </p>
                </div>
